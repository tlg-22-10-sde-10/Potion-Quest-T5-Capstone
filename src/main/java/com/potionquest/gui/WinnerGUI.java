...
public class WinnerGUI extends JFrame {
    ...
    public WinnerGUI() throws IOException {
        Game.getGameInstance().getPlayer().setCurrentLocation(Game.getLocations().get("Winning Message"));
        ...
        PotionQuestImage backgroundImage = new PotionQuestImage("images/winner.jpg");
        ...
        // titleName
        titleNameLabel = new JLabel("WINNER!");
        ...
        description = new JTextArea("You've proven loyalty & honor!");
